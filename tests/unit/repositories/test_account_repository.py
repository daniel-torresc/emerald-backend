...
class TestAccountRepository:
    ...
    async def test_get_by_user_with_filters(self, db_session, test_user):
    ...
    async def test_get_by_user_pagination(self, db_session, test_user):
    ...
    async def test_get_by_name(self, db_session, test_user):
    ...
    async def test_soft_delete_filtering(self, db_session, test_user):
