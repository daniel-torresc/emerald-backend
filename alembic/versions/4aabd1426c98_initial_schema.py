...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(name="audit_status_enum", create_type=False),
            nullable=False,
        ),
    ...
    op.create_index(
        "ix_audit_logs_user_date", "audit_logs", ["user_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "currency ~ '^[A-Z]{3}$'", name="ck_accounts_currency_format"
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
    ...
    op.create_index(
        op.f("ix_accounts_account_name"), "accounts", ["account_name"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_accounts_created_by"), "accounts", ["created_by"], unique=False
    )
    op.create_index(
        op.f("ix_accounts_currency"), "accounts", ["currency"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_accounts_updated_by"), "accounts", ["updated_by"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "permission_level",
            postgresql.ENUM(name="permissionlevel", create_type=False),
            nullable=False,
        ),
        sa.Column(
            "id",
        ...
        sa.ForeignKeyConstraint(
            ["account_id"],
            ["accounts.id"],
            name=op.f("fk_account_shares_account_id_accounts"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
            name=op.f("fk_account_shares_user_id_users"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_account_shares")),
    )
    op.create_index(
        op.f("ix_account_shares_account_id"),
        "account_shares",
        ["account_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_created_at"),
        "account_shares",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_created_by"),
        "account_shares",
        ["created_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_deleted_at"),
        "account_shares",
        ["deleted_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_permission_level"),
        "account_shares",
        ["permission_level"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_updated_by"),
        "account_shares",
        ["updated_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_account_shares_user_id"), "account_shares", ["user_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("account_id", postgresql.UUID(as_uuid=True), nullable=False),
        sa.Column(
            "parent_transaction_id", postgresql.UUID(as_uuid=True), nullable=True
        ),
        ...
        sa.CheckConstraint(
            "currency ~ '^[A-Z]{3}$'", name="ck_transactions_currency_format"
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            ["transactions.id"],
            name=op.f("fk_transactions_parent_transaction_id_transactions"),
            ondelete="SET NULL",
        ),
        sa.ForeignKeyConstraint(
            ["created_by"],
    ...
    op.create_index(
        op.f("ix_transactions_value_date"), "transactions", ["value_date"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_transactions_updated_by"), "transactions", ["updated_by"], unique=False
    )
    ...
    op.execute(
        "CREATE INDEX ix_transactions_merchant_trgm ON transactions USING GIN (merchant gin_trgm_ops)"
    )
    op.execute(
        "CREATE INDEX ix_transactions_description_trgm ON transactions USING GIN (description gin_trgm_ops)"
    )
    ...
    op.create_index(
        op.f("ix_transaction_tags_transaction_id"),
        "transaction_tags",
        ["transaction_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_transaction_tags_tag"), "transaction_tags", ["tag"], unique=False
    )
    op.create_index(
        op.f("ix_transaction_tags_created_at"),
        "transaction_tags",
        ["created_at"],
        unique=False,
    )
